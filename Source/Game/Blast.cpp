...
namespace game_framework
{
	...
	void NormalBlast::OnShow()
	{
		if (curShow < 10)
		{	//show blast circle
			normalBlast[style - 1][curShow].SetTopLeft(x - (normalBlast[style - 1][curShow].GetWidth() / 2) + 25, y - (normalBlast[style - 1][curShow].GetHeight() / 2) + 25);
	...
	void LineBlast::OnShow()
	{
		...
		{
		case 1:
			horizontal[style - 1][curShow].SetTopLeft(x - (horizontal[style - 1][curShow].GetWidth() / 2 - 25), y);
			horizontal[style - 1][curShow].ShowBitmap();
			break;
		case 2:
			vertical[style - 1][curShow].SetTopLeft(x, y - (vertical[style - 1][curShow].GetHeight() / 2 - 25));
	...
	void MagicBlast::OnShow()
	{
		if (delay)
		{
			bmp[curShow].SetTopLeft(x - bmp[curShow].GetWidth() / 2, y - bmp[curShow].GetHeight() / 2);
