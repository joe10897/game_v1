...
namespace game_framework
{
	...
	Candy::Candy(int id, int x, int y)
		...
		pushX(0), pushY(0)/*, sound(&game_framework::CGameState::sound)*/
	{ }

	Candy::Candy(int x, int y)
		: style(-1), x(x), y(y), dx(x), dy(y)/*, sound(&game_framework::CGameState::sound)*/
	{	}

	Candy::Candy()
		: style(-1)/*, sound(&game_framework::CGameState::sound)*/
	{	}
